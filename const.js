/*Book 1 column 2-Chapter3: Constant Tide/Sequina's Sales
-see what kind of product it is, but only if it is not on sale. If it is on sale, that should be the only message about the product.
 
 /*original file w/o modification*/
/*const inventory = [
